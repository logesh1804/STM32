...
int main(void)
{
  ...
  /* Init scheduler */
  /* USER CODE BEGIN RTOS_LIMIT */
  /* USER CODE END RTOS_LIMIT */
  ...
  /* Create tasks */
  /* Motor Control Task - High Priority to ensure safety overrides */
  xTaskCreate(vMotorControlTask, "MotorCtrl", 256, NULL, 3, NULL);

  /* OLED Display Task - Medium Priority */
  xTaskCreate(vDisplayTask, "OledDisp", 256, NULL, 2, NULL);

  /* Heartbeat Status LED - Low Priority */
...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Init.Period = TIM3_PERIOD_ARR - 1;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PA1 (PIR Sensor) */
  GPIO_InitStruct.Pin = GPIO_PIN_1;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure ADC Channel Pin: PA0 */
  GPIO_InitStruct.Pin = GPIO_PIN_0;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure PB6 PB7 (I2C1) */
